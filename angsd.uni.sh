...
for number in {1..22}; do angsd -sites hapmap/$number.sites.txt -bam bams.list -doMaf 2 -doMajorMinor 1 -r $number: -doGeno 18 -doPost 2 -GL 1 -out angsd/angsd.uni.chr$number; done
