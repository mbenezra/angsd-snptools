...
plot(snptools.uni.roc$callrate, snptools.uni.roc$errorrate, main = "ROC curve - SNPTOOLS vs SAMTOOLS vs GATK", xlab = "Call rate", ylab = "Error rate", col = 1, type = "l", xlim = c(0, 1), ylim = c(0, 0.05))
