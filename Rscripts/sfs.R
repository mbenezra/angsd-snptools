...
barplot(res,beside=T,legend=c("CEU","CEU","CEU"),names=1:20,main="realSFS non ancestral sites")

#plot the polymorphic sites.
resPoly <- t(apply(res[,-20],1,nnorm))
barplot(resPoly,beside=T,legend=c("CEU","CEU","CEU"),names=1:19,main="realSFS polymorphic sites")
...
barplot(resDown,beside=T,legend=c("CEU","CEU","CEU"),names=1:9,main="realSFS downsampled polymorphic sites")
