...
vcf-concat 1.out.vcf.gz 2.out.vcf.gz 3.out.vcf.gz 4.out.vcf.gz 5.out.vcf.gz 6.out.vcf.gz 7.out.vcf.gz 8.out.vcf.gz 9.out.vcf.gz 10.out.vcf.gz 1
1.out.vcf.gz 12.out.vcf.gz 13.out.vcf.gz 14.out.vcf.gz 15.out.vcf.gz 16.out.vcf.gz 17.out.vcf.gz 18.out.vcf.gz 19.out.vcf.gz 20.out.vcf.gz 21.o
ut.vcf.gz 22.out.vcf.gz | gzip -c > out.vcf.gz
...
for number in {1..22}; do angsd sites index ./prob2vcf/$number.sites.txt; done
...
angsd sites index prob2vcf/sites.txt
...
gzip --keep prob2vcf/10indv.out.recode.vcf
